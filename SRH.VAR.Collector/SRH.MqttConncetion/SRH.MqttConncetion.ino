/*
 Name:		SRH.VAR.MqttConnection.ino
...
void loop() {
	...
	{
		serialInnString.toCharArray(tmsg, 100);
		client.publish("outTopic", tmsg);
		serialInnString = "";
